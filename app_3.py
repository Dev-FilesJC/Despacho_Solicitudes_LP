...
# =========================================================
# Menú centralizado para que el usuario pueda moverse entre todos
# los módulos sin depender de botones distintos en cada sección.
# Se deja una sexta opción reservada para una futura funcionalidad.
MENU_BASE = [
...
st.markdown(
    """
    <div class="menu-titulo">☰ MENÚ DE NAVEGACIÓN</div>
    """,
    unsafe_allow_html=True,
)

nav_col1, nav_col2 = st.columns([4.5, 1])
