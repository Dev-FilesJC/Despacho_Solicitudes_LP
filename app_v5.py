...
if st.session_state.page == "comisiones":
    ...
    # El formulario NO usa expander. Inicia cerrado y solo aparece al pulsar el botón.
    ...
    # Mostrar el formulario solamente cuando el administrador lo haya abierto.
    if st.session_state.get("mostrar_form_comision", False):
