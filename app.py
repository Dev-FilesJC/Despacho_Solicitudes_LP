...
/* =========================================================
   ...
   ========================================================= */
/* FORZAR LA BARRA LATERAL VISIBLE
   Streamlit puede recordar que el usuario la dejó contraída.
   Estas reglas hacen que el menú permanezca visible. */
...
/* Evita que el botón de cierre o el estado colapsado oculte el contenido. */
...
# PORTADA
# =========================================================
# La portada se renderiza después del menú lateral. Antes se ejecutaba
# st.stop() aquí, lo que impedía que Streamlit llegara a construir el sidebar.
# =========================================================
# CARGA BAJO DEMANDA
# =========================================================
...
with st.sidebar:
    ...
    st.markdown(
        '<div class="jc-side-section">MENÚ PRINCIPAL</div>',
        unsafe_allow_html=True,
    )
    st.markdown(
...
# =========================================================
# PORTADA — renderizada DESPUÉS del sidebar
# =========================================================
