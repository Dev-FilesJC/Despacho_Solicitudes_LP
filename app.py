...
/* =========================================================
   ...
   ========================================================= */
/* IMPORTANTE: dejamos que Streamlit controle el botón nativo de
   contraer/expandir. No se oculta ni se reposiciona, así el menú
   puede cerrarse y volver a abrirse normalmente. */
