...
TIPOS_SALIDA_COMISION = ["Seleccione una opción", "COMISIÓN - ENTREGA DE DOCUMENTOS", "COMISIÓN - RECOJO DE DOCUMENTOS", "OTRA COMISIÓN"]
OPERADORES_COMISION = ["Seleccione una opción", "Alfredo", "Jonathan", "Luis"]
...
with c4:
    if es_admin() and st.button("🚶 CONTROL DE SALIDAS A COMISIÓN", use_container_width=True):
        liberar_bloqueo_edicion()
        st.session_state.editing = None
        st.session_state.editing_key = ""
