...
if st.session_state.page == "cajas":
    ...
    # El formulario de salida se controla con una bandera para poder cerrarlo automáticamente
    # cuando el usuario presiona CANCELAR.
    st.session_state.setdefault("mostrar_registro_salida", False)

    etiqueta_registro_salida = (
        "🔼 OCULTAR REGISTRO DE SALIDA"
        if st.session_state.mostrar_registro_salida
    ...
    if st.button(
        ...
        key="toggle_registro_salida",
    ):
        st.session_state.mostrar_registro_salida = not st.session_state.mostrar_registro_salida
        st.rerun()
