...
/* =========================================================
   ...
   ========================================================= */
/* Sidebar: se deja a Streamlit controlar expandir/contraer.
   Solo se aplica el aspecto visual y desplazamiento interno. */
...
# =========================================================
# PORTADA — SE DETIENE DESPUÉS DE CONSTRUIR EL SIDEBAR
# =========================================================
# IMPORTANTE: la portada debe detener la ejecución DESPUÉS de construir
# st.sidebar. Así el menú lateral permanece disponible y se puede contraer
# o volver a abrir con el control nativo de Streamlit.
if st.session_state.page == "portada":
    st.markdown(
        """
        <div style="
