...
def excel_bytes_informe_cajas_cintillos(df_salidas, df_movimientos=None, titulo_filtro="", fecha_desde=None, fecha_hasta=None):
    ...
    IMPORTANTE: la trazabilidad NO incluye cintillos.
    Cada caja se representa con dos movimientos/articulos:
    ...
    # Trazabilidad: SOLO CAJAS. Cada caja genera una BASE y una TAPA.
    # Los cintillos quedan completamente fuera de esta hoja.
    filas = []
    ...
    if not filas:
        ws.cell(8, 1, "SIN REGISTROS DE CAJAS")
        ws.merge_cells("A8:W8")
        ws["A8"].alignment = Alignment(horizontal="center")
        ws["A8"].font = Font(name="Arial", size=10, italic=True)

    anchos = [14, 62, 15, 36, 14, 14, 14, 16, 13, 13, 13, 12, 12, 13, 12, 18, 15, 22, 16, 16, 14, 14, 16]
    ...
    # =========================================================
    # RESUMEN: se conserva el resumen ejecutivo actual, pero
    # la trazabilidad y sus cantidades corresponden solamente a CAJAS.
    # =========================================================
    ...
    resumen_data = [
        ...
        ("Cintillos", "NO INCLUIDOS EN TRAZABILIDAD"),
    ...
    resumen.column_dimensions["B"].width = 48
